...
After five years in the club, he self-published a paper titled ["An Essay on the Application of Mathematical Analysis to the Theories of Electricity and Magnetism"](https://www.google.com/books/edition/An_Essay_on_the_Application_of_Mathemati/GwYXAAAAYAAJ?hl=en&gbpv=1&dq=An+Essay+on+the+Application+of+Mathematical+Analysis+to+the+Theories+of+Electricity+and+Magnetism&printsec=frontcover), which contains 90 pages of tables of observations, equations, and lengthy explanations on his experiments with electricity. In the paper, he does two very remarkable things. First, he invents the theory of potential, which is now used in everything from Riemannian geometry, to Markov chains, to Fourier transforms.
